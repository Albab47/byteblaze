...
const Navbar = () => {
  ...
  return (
    <nav className="navbar bg-base-100 shadow-lg px-4 sm:px-8 sticky z-10 justify-between">
      <div>
        <Link
          to="/"
          className="btn btn-ghost text-primary text-2xl gap-0 flex-1"
        >
      ...
      <div className="flex-none gap-4">
        <ul className="menu hidden sm:flex menu-horizontal gap-4 px-1">
